...
###### 設定網頁標題介面 
html_temp = """
		<div style="background-color:#000000;padding:20px;border-radius:15px">
...
###### 選擇金融商品
st.subheader("選擇金融商品: ")
# choices = ['台積電: 2022.1.1 至 2024.4.9']
choices = ['台積電: 2022.1.1 至 2024.4.9','英業達2020.1.2 至 2024.4.12', '堤維西2020.1.2 至 2024.4.12']
